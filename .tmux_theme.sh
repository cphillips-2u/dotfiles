...
setw -g window-status-current-format "#[fg=colour235,bg=colour236,nobold,nounderscore,noitalics]#[fg=colour0,bg=colour7] #I #[fg=colour0,bg=colour7] #W #[fg=colour7,bg=colour235,nobold,nounderscore,noitalics]"
